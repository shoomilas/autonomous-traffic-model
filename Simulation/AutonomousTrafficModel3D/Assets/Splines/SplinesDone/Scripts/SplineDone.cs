...
public class SplineDone : MonoBehaviour {
    ...
    public void AddAnchor() {
        if (anchorList == null) {
            Debug.Log("anchorList Was null");
            anchorList = new List<Anchor>();
        }
        Debug.Log("Add Anchor: Proceeding");
        var anchorListCount = anchorList.Count;
        Debug.Log($"Anchor list count: {anchorListCount.ToString()}");
        if (anchorListCount == 0) {
            anchorList.Add(new Anchor {
                position = new Vector3(1, 0, 0),
                handleAPosition = new Vector3(1, 0, 0),
                handleBPosition = new Vector3(1, 0, 0),
            });
        }
        else {
            ...
            anchorList.Add(new Anchor {
                ...
                handleAPosition = lastAnchor.handleAPosition + new Vector3(1, 0, 0),
                handleBPosition = lastAnchor.handleBPosition + new Vector3(1, 0, 0),
            });
        }
    }

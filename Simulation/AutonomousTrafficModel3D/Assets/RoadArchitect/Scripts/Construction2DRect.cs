...
namespace RoadArchitect {
    public class Construction2DRect {
        ...
        private void Construction2DRectDo(ref Vector2 _P1, ref Vector2 _P2, ref Vector2 _P3, ref Vector2 _P4,
            ref float _height) {
            P1 = _P1;
            P2 = _P2;
            P3 = _P3;
            ...
            if (RootUtils.IsApproximately(P1.x, P2.x, 0.0001f)) P2.x += 0.0002f;
            if (RootUtils.IsApproximately(P1.x, P3.x, 0.0001f)) P3.x += 0.0002f;
            if (RootUtils.IsApproximately(P1.x, P4.x, 0.0001f)) P4.x += 0.0002f;
            if (RootUtils.IsApproximately(P2.x, P3.x, 0.0001f)) P3.x += 0.0002f;
            if (RootUtils.IsApproximately(P2.x, P4.x, 0.0001f)) P4.x += 0.0002f;
            if (RootUtils.IsApproximately(P3.x, P4.x, 0.0001f)) P4.x += 0.0002f;

            if (RootUtils.IsApproximately(P1.y, P2.y, 0.0001f)) P2.y += 0.0002f;
            if (RootUtils.IsApproximately(P1.y, P3.y, 0.0001f)) P3.y += 0.0002f;
            if (RootUtils.IsApproximately(P1.y, P4.y, 0.0001f)) P4.y += 0.0002f;
            if (RootUtils.IsApproximately(P2.y, P3.y, 0.0001f)) P3.y += 0.0002f;
            if (RootUtils.IsApproximately(P2.y, P4.y, 0.0001f)) P4.y += 0.0002f;
            if (RootUtils.IsApproximately(P3.y, P4.y, 0.0001f)) P4.y += 0.0002f;
        ...
        public bool Contains(ref Vector2 _p) {
            ...
            //  return false;
            //}
            if (Vector2.SqrMagnitude(_p - P1) > MaxDistanceSQ) return false;
            //if(poly.Length != 4)
            //{
            //  return false;
            //}

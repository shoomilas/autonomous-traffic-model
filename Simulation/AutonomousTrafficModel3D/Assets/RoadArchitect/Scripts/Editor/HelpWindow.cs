...
namespace RoadArchitect {
    public class HelpWindow : EditorWindow {
        private void OnGUI() {
            ...
            if (GUILayout.Button("Click here to open offline manual", EditorStyles.toolbarButton,
                GUILayout.Width(310f))) EditorUtilities.OpenOfflineManual();
            ...
            EditorGUILayout.LabelField(
                "Please visit us or reach out to us on Github (links below) with any questions or comments.");
            EditorGUILayout.LabelField(
                "If you encounter Bugs or have a Feature Suggestion, you can submit them on the following sites:");
        ...
        public void Initialize() {
            var rect = new Rect(340, 170, 400, 400);
            position = rect;
            Show();

...
namespace RoadArchitect {
    ...
    public class TerrainHistoryMaker {
        ...
        public TreeInstance[] MakeTrees() {
            if (oldTrees == null || oldTrees.Length < 1) return null;
            var tSize = oldTrees.Length;
            ...
            for (var index = 0; index < tSize; index++) {
                ...
                xTree.lightmapColor = new Color(tTree.lightmapColorR, tTree.lightmapColorG, tTree.lightmapColorB,
                    tTree.lightmapColorA);

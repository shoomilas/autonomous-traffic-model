...
namespace UnityStandardAssets.Cameras {
    ...
    public class AutoCam : PivotBasedCameraRig {
        ...
        [SerializeField]
        private bool m_FollowVelocity; // Whether the rig will rotate in the direction of the target's velocity.
        ...
        protected override void FollowTarget(float deltaTime) {
            ...
            if (!m_FollowTilt) {
                targetForward.y = 0;
                if (targetForward.sqrMagnitude < float.Epsilon) targetForward = transform.forward;
            }

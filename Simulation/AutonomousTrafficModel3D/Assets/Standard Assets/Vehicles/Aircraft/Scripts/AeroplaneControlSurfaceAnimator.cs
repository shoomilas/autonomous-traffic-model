...
namespace UnityStandardAssets.Vehicles.Aeroplane {
    public class AeroplaneControlSurfaceAnimator : MonoBehaviour {
        ...
        private void Start() {
            ...
            foreach (var surface in m_ControlSurfaces) surface.originalLocalRotation = surface.transform.localRotation;
        }
            ...
            foreach (var surface in m_ControlSurfaces)
                switch (surface.type) {
                    case ControlSurface.Type.Aileron:
                    {
                        ...
                        var rotation = Quaternion.Euler(surface.amount * m_Plane.RollInput, 0f, 0f);
                    ...
                    case ControlSurface.Type.Elevator:
                    {
                        ...
                        var rotation = Quaternion.Euler(surface.amount * -m_Plane.PitchInput, 0f, 0f);
                        RotateSurface(surface, rotation);
                        break;
                    }
                    case ControlSurface.Type.Rudder:
                    {
                        ...
                        var rotation = Quaternion.Euler(0f, surface.amount * m_Plane.YawInput, 0f);
                        RotateSurface(surface, rotation);
                        break;
                    }
                    case ControlSurface.Type.RuddervatorPositive:
                    {
                        ...
                        var r = m_Plane.YawInput + m_Plane.PitchInput;
                        var rotation = Quaternion.Euler(0f, 0f, surface.amount * r);
                        RotateSurface(surface, rotation);
                        break;
                    }
        ...
        private void RotateSurface(ControlSurface surface, Quaternion rotation) {
            ...
            var target = surface.originalLocalRotation * rotation;

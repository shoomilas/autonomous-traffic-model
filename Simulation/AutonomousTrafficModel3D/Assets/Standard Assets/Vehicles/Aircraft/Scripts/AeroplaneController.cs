...
namespace UnityStandardAssets.Vehicles.Aeroplane {
    ...
    public class AeroplaneController : MonoBehaviour {
        ...
        private bool m_Immobilized; // used for making the plane uncontrollable, i.e. if it has been hit or crashed.
        ...
        public float
            ForwardSpeed { get; private set; } // How fast the aeroplane is traveling in it's forward direction.

        public float EnginePower { get; private set; } // How much power the engine is being given.
        public float MaxEnginePower => m_MaxEnginePower; // The maximum output of the engine.
        ...
        private void ControlThrottle() {
            ...
            if (m_Immobilized) ThrottleInput = -0.5f;
        ...
        private void CalculateDrag() {
            ...
            m_Rigidbody.drag =
                AirBrakes ? (m_OriginalDrag + extraDrag) * m_AirBrakesEffect : m_OriginalDrag + extraDrag;
